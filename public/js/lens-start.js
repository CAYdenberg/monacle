if (window.Lens === undefined) {
        window.Lens = require("/js/lens.js");
      }
      ...
      // PLOS Bio example
      var documentURL = "data/pbio_1001749/index.xml";
      ...
      //used a regexp because we can later match in body of URL and eliminate the
      //? altogether. Just need to direct all requests to this folder thru index.html
      var reg = new RegExp(/PMC(\d+)/);
      var pmcId = document.URL.match(reg)[0];
      console.log(pmcId);
      var app = new Lens({
        document_url: "http://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=pmc&id=" + pmcId.replace("PMC", ""),
      });
